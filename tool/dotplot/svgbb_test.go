...
func TestSvgBB(t *testing.T) {
	...
	want := "<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" xml:space=\"preserve\" width=\"105\" height=\"105\" viewBox=\"0 0 105 105\">\n" +
		...
		"\t<text y=\"75\" x=\"10\" font-size=\"12\" text-anchor=\"middle\" transform=\"rotate(-90, 10, 75)\">Baits</text>\n" +
		"</svg>\n"
	SvgBB(dist, sorted, "blueBlack")
	svg, _ := afero.ReadFile(fs.Instance, "svg/bait-bait.svg")
	assert.Equal(t, want, string(svg), "Bait-bait svg not generated correctly")
}
