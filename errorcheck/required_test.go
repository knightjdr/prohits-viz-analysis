...
func TestRequired(t *testing.T) {
	...
	// TEST: no data panics and logs message.
	data = []map[string]string{}
	...
	// TEST: abundance column should be a pipe-separated list of numbers.
	data = []map[string]string{
	...
	// TEST: score column should be a float64.
	data = []map[string]string{
		{"abundance": "2", "condition": "a", "control": "1|5|2", "readout": "b", "readoutLength": "10", "score": "a"},
		{"abundance": "2|3.1", "condition": "c", "control": "2|5.1|2", "readout": "d", "readoutLength": "1", "score": "0.1"},
		{"abundance": "4", "condition": "e", "control": "1", "readout": "f", "readoutLength": "100", "score": "0.8"},
	}
	dataset.FileData = data
	...
	// TEST: readout length column should be parsable as an integer.
	data = []map[string]string{
	...
	// TEST: control column should be a pipe-separated list of numbers.
	data = []map[string]string{
