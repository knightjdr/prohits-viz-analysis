...
// DotplotParameters conatins dotplot parameters.
...
// DotplotParametersDefine generates dotplot dimensions for an SVG.
func DotplotParametersDefine(dims HeatmapDimensions) (parameters DotplotParameters) {
